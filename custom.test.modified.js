...
describe('Custom Tests', function () {
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
      ...
      // Bob withdraws his funds from L2
      ...
      // Alice withdraws her funds from L1
      const aliceWithdrawAmount = utils.parseEther('0.07')
      const aliceEthAddress = '0x35F6996832a5e6C244015532f8d633B369040987'
      const aliceWithdrawUtxo = new Utxo({ amount: aliceChangeUtxo.amount.sub(aliceWithdrawAmount), keypair: aliceKeypair })
      await transaction({
        tornadoPool,
